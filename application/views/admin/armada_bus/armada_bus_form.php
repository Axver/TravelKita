	...
	<div class="main-panel">
		...
		<div class="content">
			<div class="container-fluid">
				<!-- your content here -->
				<h2 style="margin-top:0px">Armada_bus <?php echo $button ?></h2>
				<form action="<?php echo $action; ?>" method="post">
					<div class="form-group">
						<label for="varchar">Nama Armada <?php echo form_error('nama_armada') ?></label>
						<input type="text" class="form-control" name="nama_armada" id="nama_armada" placeholder="Nama Armada" value="<?php echo $nama_armada; ?>" />
					</div>
					<div class="form-group">
					...
					<a href="<?php echo site_url('armada_bus') ?>" class="btn btn-default">Cancel</a>
			</div>
		</div>
		<footer class="footer">
			<div class="container-fluid">
