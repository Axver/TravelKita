			...
			<div class="container-fluid">
				...
				<form action="<?php echo $action; ?>" method="post">
					<div class="form-group">
						<label for="varchar">Kode Diskon <?php echo form_error('kode_diskon') ?></label>
						<input type="text" class="form-control" name="kode_diskon" id="kode_diskon" placeholder="Kode Diskon" value="<?php echo $kode_diskon; ?>" />
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="int">Masa Berlaku <?php echo form_error('masa_berlaku') ?></label>
					...
					<div class="form-group">
						<label for="varchar">Logic Diskon <?php echo form_error('logic_diskon') ?></label>
						<input type="text" class="form-control" name="logic_diskon" id="logic_diskon" placeholder="Logic Diskon" value="<?php echo $logic_diskon; ?>" />
					</div>
					<input type="hidden" name="id_diskon" value="<?php echo $id_diskon; ?>" />
