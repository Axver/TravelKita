					...
					foreach ($kecamatan_data as $kecamatan)
					{
						...
						<tr>
							...
							<td style="text-align:center" width="200px">
								<?php
								echo anchor(site_url('kecamatan/read/'.$kecamatan->id_kecamatan),'Read');
								echo ' | ';
								echo anchor(site_url('kecamatan/update/'.$kecamatan->id_kecamatan),'Update');
								echo ' | ';
								echo anchor(site_url('kecamatan/delete/'.$kecamatan->id_kecamatan),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
								?>
							</td>
						</tr>
						<?php
